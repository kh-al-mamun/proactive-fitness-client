        ...
        <div className="grid sm:grid-cols-2 min-h-[92vh]">
            ...
            <div className="flex flex-col items-center justify-center bg-slate-300">
                <div className="hover:animate-ping">
                    <h1 className="text-2xl font-semibold text-center">Welcome Learner!</h1>
                    <h3 className="text-lg text-center">Where do you want to go?</h3>
                </div>
            </div>

            <div className="bg-orange-300">
                <Link to={'/dashboard/selected-classes'}>
                    <button className="h-1/3 w-full border-b border-orange-400 text-xl font-semibold hover:bg-orange-400 flex justify-center items-center gap-3">
                ...
                <Link to={'/dashboard/enrolled-classes'}>
                    <button className="h-1/3 w-full border-t border-orange-400 text-xl font-semibold hover:bg-orange-400 flex justify-center items-center gap-3">
